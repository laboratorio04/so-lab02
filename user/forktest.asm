...
forktest(void)
{
  ...
  34:	40850513          	addi	a0,a0,1032 # 438 <sync+0xe>
  ...
  56:	43650513          	addi	a0,a0,1078 # 488 <sync+0x5e>
  ...
  6c:	3e050513          	addi	a0,a0,992 # 448 <sync+0x1e>
  ...
  7e:	3e650513          	addi	a0,a0,998 # 460 <sync+0x36>
  ...
  ae:	3ce50513          	addi	a0,a0,974 # 478 <sync+0x4e>
